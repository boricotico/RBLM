        ...
        <tr>
		  ...
		  <table width="100%" border="0" cellspacing="0" cellpadding="0" style="height:427px;">
            <tr>
			  ...
			  <div align="left" class="txtRojo14">Teens</div>
			  <br />
			  <table align="center" width="450" border="0" cellpadding="5" style="background-color:#9FD4FF;">
			  <?php
			  
			  	$query = "SELECT id_cartera,nombre,carpeta,fechaNacimiento FROM cartera 
						WHERE status = 1
						AND fechaNacimiento > DATE_SUB(CURDATE(),INTERVAL 19 YEAR)
						ORDER BY nombre"; 
				...
				$i = 0;
				while(list($id,$nombre,$carpeta,$fnac) = mysql_fetch_row($resultado_qry))
				{
				...
				<a href="perfil.php?idc=<?=$id?>" title="<?=$nombre?>::<?=$edad?> años" class="Tips4">
